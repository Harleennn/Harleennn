...
- 🗄️ Analyze and query data using **SQL**
...
- 📄 **Job Opportunity Aggregator** – Django-based system with PDF scraping & LLM summaries
...
- 📊 Advanced **DAX & Power BI reporting techniques**
- 🗄️ Real-world **SQL case studies & optimization**
- 🐍 Automation & analytics workflows using Python
...
### ⚙️ Development & Tools
Django • PostgreSQL • Git • GitHub • VS Code  
